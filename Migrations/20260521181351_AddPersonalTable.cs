...
namespace VitalManager.API.Migrations
{
    /// <inheritdoc />
    public partial class AddPersonalTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_espacio = table.Column<int>(type: "integer", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_insumo_medico", x => x.id_insumo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_personal_medico", x => x.id_personal);
                });
